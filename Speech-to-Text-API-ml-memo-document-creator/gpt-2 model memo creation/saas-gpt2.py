...
def text_summarizer(text, max_length=150):
    ...
    # Decode and format the summary in memo format with bullet points
    summary = tokenizer.decode(summary_ids[0], skip_special_tokens=True)

    # Split the summary into sentences and add bullet points
...
if __name__ == "__main__":
    ...
    print("\nSummary (Memo Format with Bullet Points):")
    print(summary)
